...
public class SportsCar extends Car implements AirCon, AutoDrive{
    ...
    public SportsCar(boolean isAirCon, int setTemp, boolean isAutoDrv, int speed, String color, String year) {
    ...
    @Override
    public void airConON() {System.out.println("에어컨을 켰습니다.");

    }

    @Override
    public void airConOFF() {System.out.println("에어컨을 껐습니다.");

    }

    @Override
    public void setairConTemp(int tmp) {System.out.println("에어컨을 설정 온도를 " + tmp + "로 변경 합니다.");

    }

    @Override
    public void autoDrivON() {System.out.println("자율 주행 모드를 켰습니다.");

    }

    @Override
    public void autoDrivOFF() {System.out.println("자율 주행 모드를 껐습니다.");
