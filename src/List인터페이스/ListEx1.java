...
// 리스트 구조는 배열과 유사하고 차이점으로 동적 크기가 변한다는 점
// ArrayList, Linked List, Vector 거의 동일한 메소드를 가지고 있어 코드 변환이 자유로음
...
public class ListEx1 {
    public static void main(String[] args) {
        ...
        // Arrays.asList(arr) : 이미 만들어진 배열을 ArrayList로 추가
...
//        list.add("300");
        ...
        // remove(인데스) : 해당 인덱스의 값을 삭제하고 삭제된 값을 반환
