package 참조타입기초;
// 자바의 데이터 타입은 기본 타입과 참조 타입을 나누어 집니다.
...
public class RefType {
    public static void main(String[] args) {
        ...
        // 참조 타입 예제
        String name = "곰돌이 사육사"; // Strimg형으로 만들어진 name에는 실제 "곰돌이사육사" 라는 문자열이 없고 주소만 있음
...
//        System.out.println(intValue);
        ...
        if (strVal1 == strVal3) {// 주소가 같은지 물어 봄
            System.out.println("strVal1과 strVal3은 참조하는 주소가 같음");
        }else {
            System.out.println("strVal1과 strVal3은 참조하는 주소가 다름");
        }
