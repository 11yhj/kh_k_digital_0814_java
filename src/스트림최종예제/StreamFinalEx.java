...
class TravelCustomer{
    ...
    public TravelCustomer (String name, int age, int priee){
        this.name =name;
        this.age =age;
        this.priee =priee;
