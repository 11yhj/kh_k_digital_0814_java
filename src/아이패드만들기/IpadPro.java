...
public class IpadPro {
    ...
    IpadPro(String name) {
        ...
        productDate = sdf.format(now); // 생산한 년/월/일 을 가져옴
        cnt++;
    ...
    boolean continueOrder() {
        ...
        System.out.println("구매하시려면 yes / 종료는 quit : ");
    ...
    void setNetwork() {
        ...
        while (true) {
            ...
            System.out.print("네트워크를 다시 선택 하세요.");
    ...
    void productPad(){
        ...
        System.out.println("일렬번호 : " + serialNum);
